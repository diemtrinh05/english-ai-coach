...
| `BE-FND-002` | Dựng modular-monolith package/module skeleton | CBL | `BE-FND-001` | P0 | AR,QAR | Có module/package cho auth,user,onboarding,vocabulary,learning,personalization,quiz,progress,gamification,notification,ai,admin,audit,common; dependency direction đúng Architecture v1.3. | Theo global DoD + acceptance. | IN_REVIEW |
