...
| `BE-FND-003` | Thiết lập application profiles và typed configuration | CBL | `BE-FND-001` | P0 | AR,SR,QAR | `application.yml/local/test/prod`; typed properties cho assessment/SRS/personalization/gamification/notification/idempotency; default constants khớp baseline. | Theo global DoD + acceptance. | IN_REVIEW |
