...
| `DB-FND-002` | Tạo Flyway schema baseline cho 34 bảng | CBL | `DB-FND-001` | P0 | DBR,AR,QAR | Fresh DB migrate từ zero tạo đúng 34 bảng theo DB v1.6; migration append-only; FK/unique/check/not-null đầy đủ. | Theo global DoD + acceptance. | IN_REVIEW |
