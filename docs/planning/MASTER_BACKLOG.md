...
| `DB-FND-001` | Dựng PostgreSQL local + Docker Compose | CBL | `BE-FND-001` | P0 | DBR,QAR | Local PostgreSQL start/stop reproducible; credential lấy từ env; healthcheck hoạt động. | Theo global DoD + acceptance. | IN_REVIEW |
